...
#if ! defined(USB_STRING_SER_SZ)
 #define USB_STRING_SER
 #define USB_STRING_SER_SZ		0
#endif
...
#if USB_STRING_SER_SZ
 #define USB_DEVICE_IDX_SER		USB_STRING_IDX_SER
#else
 #define USB_DEVICE_IDX_SER		USB_STRING_IDX_NUL
#endif
