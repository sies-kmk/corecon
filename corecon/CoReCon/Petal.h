#if ! defined(__Petal_h__) && defined(BlackPetal)
/*******************************************************************************
 * File Name	: Petal.h
 ...
 * =================
 *
 * PB0 --               PC0 (/XTAL2)            PD0 R F         o
 * PB1 Col 4     i      PC1 (/RESET)            PD1 R E         o
 * PB2 Col 3     i      PC2 Col 0      i        PD2 R A         o
 * PB3 Col 1     i                              PD3 --
 * PB4 Col 2     i      PC4 --                  PD4 R B         o
 * PB5 Col 7     i      PC5 NUM LED    o        PD5 R C         o
 * PB6 Col 6     i      PC6 CAP LED    o        PD6 R D         o
 * PB7 SCR LED   o      PC7 Col 5      i        PD7 HWB     
 *
 * $Id$
 ******************************************************************************/
...
#define	ROW_K			mR(mR16)
#define	ROW_L			mR(mR15)
...
#define	COL_1			{ &PORTB, _BV(PB3) }
#define	COL_2			{ &PORTB, _BV(PB4) }
#define	COL_3			{ &PORTB, _BV(PB2) }
#define	COL_4			{ &PORTB, _BV(PB1) }
#define	COL_5			{ &PORTC, _BV(PC7) }
#define	COL_6			{ &PORTB, _BV(PB6) }
...
#define	bCOL6			PB6	/* Space bar column */
